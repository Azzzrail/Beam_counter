...
#et_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { ja[2] }]; #IO_L4N_T0_15 Sch=ja[3]
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { GHzClk }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
